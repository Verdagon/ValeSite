            ...
            <div className={cssns("left")}>
              <div className={cssns("main")}>
                ...
                <ul className={cssns("cozy")}>
                  ...
                  <li className={cssns()}>Sending updates across the network to other devices.</li>
                </ul>
...
{`let myEffect = ListAppendEffect(6, 11)`}
              ...
              <div className={cssns("networking")}>
                <h3 className={cssns("noline")}>Networking with Effects</h3>
                ...
                <div className={cssns("content")}>
                  ...
                  <ul className={cssns("cozy")}>
                    <li className={cssns()}>Listens for clients to connect via sockets.</li>
                    <li className={cssns()}>Once a client connects, the server sends the initial superstructure (in {incode("Flat")} form) using the {incode(".toFlat()")} method.</li>
                    <li className={cssns()}>It observes the superstructure for further changes, which it then sends along to all listening clients.</li>
                  </ul>
                </div>
                ...
                <div className={cssns("content")}>
                  ...
                  <ul className={cssns("cozy")}>
                    <li className={cssns()}>Connects to a server</li>
                    <li className={cssns()}>Receives the initial data in {incode("Flat")} form, and converts them to a superstructure using the {incode(".fromFlat()")} method.</li>
                    <li className={cssns()}>It keeps the socket open to listen for more effects and applies them as they come in.</li>
                  </ul>
                </div>
